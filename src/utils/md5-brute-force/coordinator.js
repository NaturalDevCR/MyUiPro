...
for (var i = 0; i < numWorkers; i++) {
  ...
  worker.postMessage({ cmd: "setPassToCrack", data: "3a27aecbc0fb1cda0e6f953c17c6b0f2" })

  // Start worker
  worker.postMessage({ cmd: "performCrack", data: {start: i, hop: numWorkers} })
}

status("Searching for password match for hash '3a27aecbc0fb1cda0e6f953c17c6b0f2'.")
